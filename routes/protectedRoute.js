...
/*
    *  This route is only accessible to connected users
    *
    *  => we use it to provide users with features only available to connected users
    *  => if an unconnected user tries to use this part of the API, he’ll be rejected with an Unauthorized code (401)
*/
